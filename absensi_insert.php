...
<html>
  ...
  <body class="fix-header card-no-border">
              ...
              <div class="container-fluid">
                  ...
                  <div class="row page-titles">
                      <div class="col-md-6 col-8 align-self-center">
                          <h3 class="text-themecolor m-b-0 m-t-0">Add Absensi</h3>
                          <ol class="breadcrumb">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                              <select name="nik" id="karyawan" class="form-control">
                                                  <option value="None" selected="Selected">--Select Karyawan--</option>
                                              </select>
                                              <span class="help-block"></span>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label class="control-label col-md-5">Absen Masuk</label>
                                          <div class="col-md-9">
                                              <input name="absen_masuk" placeholder="Absen_masuk" class="form-control" type="time">
                                              <span class="help-block"></span>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label class="control-label col-md-5">Absen Keluar</label>
                                          <div class="col-md-9">
                                              <input name="absen_keluar" placeholder="Absen Keluar" class="form-control" type="time">
                                              <span class="help-block"></span>
                                          </div>
                                      </div>
      ...
      <script type="text/javascript">
        $.getJSON("json/karyawan.json", function(obj) {
            $.each(obj.records, function(key, value) {
                $("#karyawan").append("<option>" + value.nik + " - " + value.nama + "</option>");
            });
        });
      </script>
  </body>
