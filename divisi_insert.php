              ...
              <div class="container-fluid">
                  ...
                  <div class="row page-titles">
                      <div class="col-md-6 col-8 align-self-center">
                          <h3 class="text-themecolor m-b-0 m-t-0">Add Divisi</h3>
                          <ol class="breadcrumb">
                                 ...
                                 <form method="POST" action="">
                                    ...
                                    <div class="form-body">
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                              <input name="kode" placeholder="Kode Divisi" class="form-control" type="number">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                              <input name="nama_divisi" placeholder="Nama Divisi" class="form-control" type="text">
                                              <span class="help-block"></span>
                                          </div>
                                      </div>
