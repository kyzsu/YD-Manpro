...
if (isset($_POST["id"])) {
    ...
    $post["nama_divisi"] = isset($_POST["nama_divisi"]) ? $_POST["nama_divisi"] : "";
                  ...
                  <nav class="sidebar-nav">
                      <ul id="sidebarnav">
                          ...
                          <?php if($akses=='1'):?>
                              ...
                              <li><a href="view_divisi.php" class="waves-effect active"><i class="fa fa-table m-r-10" aria-hidden="true"></i>Data Divisi</a></li>
              ...
              <div class="container-fluid">
                  ...
                  <div class="row page-titles">
                      <div class="col-md-6 col-8 align-self-center">
                          <h3 class="text-themecolor m-b-0 m-t-0">Edit Divisi</h3>
                          <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                              <li class="breadcrumb-item"><a href="view_divisi.php">Divisi</a></li>
                          ...
                          <div class="card">
                              <div class="card-block">
                                 <?php if (isset($_GET["id"])): ?>
                                    <form method="POST" action="divisi_update.php">
                                    <div class="col-md-6">
                                     <input type="hidden" value="<?php echo $id ?>" name="id"/>
                                     <div class="form-group">
                                      <label for="inputFName">Kode Divisi</label>
                                      <input type="text" class="form-control" required="required" id="inputKode" value="<?php echo $jsonfile["kode"] ?>" name="kode" placeholder="First Name">
                                      <span class="help-block"></span>
                                     </div>
                                     
                                     <div class="form-group">
                                      <label for="inputLName">Nama Divisi</label>
                                      <input type="text" class="form-control" required="required" id="inputLName" value="<?php echo $jsonfile["nama_divisi"] ?>" name="nama_divisi" placeholder="Last Name">
                                      <span class="help-block"></span>
                                     </div>
                                     ...
                                     <div class="form-actions">
                                      ...
                                      <a type="button" href="view_divisi.php" class="btn btn-danger" data-dismiss="modal">Cancel</a>
                                     </div>
                                    </div>
                                    </form>
                                <?php endif; ?>     
