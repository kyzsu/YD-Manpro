                      ...
                      <div class="col-12">
                          <div class="card">
                              <div class="card-block">
                                <?php if($akses=='1'):?>
                                  <a href="absensi_insert.php" class="btn btn-success"><i class="fa fa-plus"></i> Add Absensi</a>
                                  <a href="print_json_absensi.php" class="btn btn-warning"><i class="fa fa-print"></i> Print Absensi</a>
                                <hr>
                                  ...
                                  <tbody>
                                      <?php $no=0;foreach ($jsonfile->records as $index => $obj): $no++;  ?>
                                        <tr>
                                         ...
                                         <td><?php echo $obj->absen_masuk; ?></td>
                                         <td><?php echo $obj->absen_keluar; ?></td>
                                         <td>
                                          <a class="btn btn-sm btn-info" href="absensi_update.php?id=<?php echo $index; ?>"><i class="fa fa-pencil"></i></a>
                                         </td>
                                        </tr>
                                      <?php endforeach; ?>
                                  </tbody>
