...
<html>
  ...
  <head>
      ...
      <title>DASHBOARD | FTI UKSW</title>
      <!-- Bootstrap Core CSS -->
                      ...
                      <div class="col-12">
                          <div class="card">
                              <div class="card-block">
                                  <?php if($akses=='1'):?>
                                    <h2>Untuk Tambah Data Fingeprint</h2>
                                    <a href="#" class="btn btn-success"><i class="fa fa-plus"></i> Add Data</a>
                                    <hr>
                                    <center>
                                      <img src="assets/images/k2i.png" height="400" width="400">
                                    </center>
                                  <?php else:?>
                                    This is Dashboard
                                  <?php endif;?>
