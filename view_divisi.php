...
<html>
  ...
  <body class="fix-header card-no-border">
                      ...
                      <div class="col-12">
                          <div class="card">
                              <div class="card-block">
                                <?php if($akses=='1'):?>
                                  <a href="divisi_insert.php" class="btn btn-success"><i class="fa fa-plus"></i> Add Divisi</a>
                                  <a href="print_json_divisi.php" class="btn btn-warning"><i class="fa fa-print"></i> Print Divisi</a>
                                <?php endif;?>
                                <hr>
                                  ...
                                  <tbody>
                                      <?php $no=0;foreach ($jsonfile->records as $index => $obj): $no++;  ?>
                                        <tr>
                                         ...
                                         <td><?php echo $obj->nama_divisi; ?></td>
                                         <td>
                                          <a type="button" href="divisi_update.php?id=<?php echo $index; ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
                                          <button class="btn btn-sm btn-danger" onclick="delete_divisi('<?php echo $index; ?>')"><i class="fa fa-trash"></i></button>
                                         </td>
                                        </tr>
                                      <?php endforeach; ?>
                                  </tbody>
      ...
      <script type="text/javascript">
        ...
        function delete_divisi(kode)
        {
            if(confirm('Are you sure delete this data?'))
            {
                window.location.replace("divisi_delete.php?kode="+kode);
            }
        }
      </script>
  </body>
