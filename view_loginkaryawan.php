        ...
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
          <div class="card card-signin my-5">
            ...
            <div class="card-body">
              ...
              <form class="form-signin" action="loginkaryawan.php" method="post">
                ...
                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="logedink">Login</button>
              </form>
            </div>
